...
const Footer = () => {
  return (
    <footer className="bg-aquify-lightBlue py-8 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              <Droplets className="h-8 w-8 text-aquify-blue" />
              <span className="text-xl font-bold text-aquify-darkBlue">Aquify</span>
            </Link>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Aquify. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

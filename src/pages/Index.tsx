    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20 pb-32 px-6 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-blue-50/80 via-white/40 to-white pointer-events-none">
            <div className="absolute inset-0 opacity-20">
              <div className="waves-bg animate-wave"></div>
            </div>
          </div>
          
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col items-center max-w-5xl mx-auto">
              <h1 className="text-6xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-aquify-darkBlue to-aquify-blue mb-6 animate-fade-in tracking-tight leading-none text-center">
                Find Free Water Refill Stations Across India
              </h1>
              <p className="text-xl md:text-2xl text-gray-700 mb-10 animate-fade-in-delay max-w-3xl mx-auto leading-relaxed text-center">
                Join our mission to reduce plastic waste and provide access to clean drinking water for everyone.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
                <Button 
                  className="bg-aquify-blue hover:bg-aquify-darkBlue text-lg px-8 py-4 rounded-full
                ...
                <Button 
                  variant="outline" 
                  className="border-2 border-aquify-blue text-aquify-blue hover:bg-aquify-blue/5 
                            text-lg px-6 py-3 rounded-full transform hover:scale-105 transition-all duration-300"
                  size="lg"
        ...
        <section className="py-16 px-6 bg-white text-center">
          <div className="container mx-auto">
            <h2 className="text-4xl font-bold text-gray-900 mb-12 animate-fade-in">How Aquify Works</h2>
        ...
        <section className="py-16 px-6 bg-white text-center">
          <div className="container mx-auto max-w-4xl">
            ...
            <p className="text-lg text-gray-700 mb-8 animate-fade-in">
              Start using Aquify today to find free water refill stations, contribute to the community, and reduce plastic waste across India.
            </p>
